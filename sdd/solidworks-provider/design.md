...
- For basic MVP: index-based ("1" from profiles list) + simple named tags created at sketch time (in-mem sufficient). Full persistent ID + IAttribute propagation is #272 follow-up.
